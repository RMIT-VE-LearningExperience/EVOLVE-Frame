try{
var data=Newtonsoft.Json.Linq.JArray.Parse(System.IO.File.ReadAllText(@"C:\Users\Stormtrooper\Git\EVOLVE - Frame\output\revit\floor_members_manifest.json"));
...
using(var tx=new Transaction(document,"Leichhardt - supplier floor joist timber members")){tx.Start();
